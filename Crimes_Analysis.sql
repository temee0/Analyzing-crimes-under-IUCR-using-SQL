...
update crimes_iucr
SET location_description = 'OTHERS'
...
# 10. Frequency of crimes in Bottom 20 distinct location description.
select distinct location_description, count(distinct id) as 'number of cases'
from crimes_IUCR
group by location_description 
...
select distinct description from homicide
